      ...
      <section id="tournaments" style={{padding:"100px 32px",maxWidth:1200,margin:"0 auto",position:"relative",zIndex:1}}>
        ...
        <div style={{display:"flex",gap:28,flexWrap:"wrap",alignItems:"flex-start",justifyContent:"center",marginTop:20}}>
          ...
          <div style={{flex:"1 1 320px",maxWidth:440}}>
            <div style={{display:"inline-block",background:"linear-gradient(135deg,#c8a96e,#e8c88a)",color:"#04080f",fontSize:11,fontWeight:800,padding:"4px 14px",borderRadius:20,letterSpacing:1,marginBottom:14}}>🏆 {lang==="he"?"טורניר קרוב":"Upcoming Tournament"}</div>
            ...
            <div style={{display:"flex",flexDirection:"column",gap:10,marginBottom:20}}>
              <span style={{color:"#aebfd8",fontSize:15}}>📅 {lang==="he"?"יום ראשון, 21.6":"Sunday, June 21"}</span>
              <span style={{color:"#aebfd8",fontSize:15}}>🕙 10:00–15:00</span>
              <span style={{color:"#aebfd8",fontSize:15}}>📍 {lang==="he"?"פאדל טיים, רעננה":"Padel Time, Raanana"}</span>
              <span style={{color:"#aebfd8",fontSize:15}}>🎾 {lang==="he"?"רמות 4.0–4.5 · 16 קבוצות · מקומות מוגבלים":"Levels 4.0–4.5 · 16 teams · limited spots"}</span>
            </div>
            <div style={{background:"rgba(200,169,110,0.08)",border:"1px solid rgba(200,169,110,0.3)",borderRadius:8,padding:"14px 16px",marginBottom:22}}>
              <div style={{color:GOLD,fontSize:13,fontWeight:800,marginBottom:7}}>{lang==="he"?"💰 פרסים":"💰 Prizes"}</div>
